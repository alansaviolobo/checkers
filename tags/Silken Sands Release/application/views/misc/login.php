...
echo "<p align='center'>";
echo "<img src='" . base_url () . "/resource/image/Silken Sands Logo.png'/>";
echo "</p>";
echo "<br />";
...
if (isset ( $error ))
	echo "<h5>$error</h5>";
echo "<p align='center'>";
echo "<img src='" . base_url () . "/resource/image/checkers_small.png'>";
echo "&nbsp;&nbsp;&nbsp;By&nbsp;&nbsp;&nbsp;";
echo "<img src='" . base_url () . "/resource/image/technotrix.png'/>";
echo "</p>";
echo "</div>";
echo form_close ();
?>