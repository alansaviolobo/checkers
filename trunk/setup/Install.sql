...
('Set Meals Vegetarian',180,'Food'),
('Set Meals Non Vegetarian',210,'Food'),
...
('Poha',50,'Food'),
('Porridge with hot or cold milk',60,'Food'),
('Puri Bhaji',80,'Food'),
('Toast Butter',50,'Food'),
('Vegetable Cutlets',80,'Food'),
('Curds',60,'Food'),
('Mixed Raita',80,'Food'),
('Papad',20,'Food'),
...
('Chicken Sandwiches',60,'Food'),
('Egg Sandwiches',60,'Food'),
('Non-Vegetable Club Sandwiches',120,'Food'),
('Vegetable Club Sandwiches',80,'Food'),
('Vegetable Sandwiches',60,'Food'),
('Chicken Hawaiian Salad',100,'Food'),
...
('Chicken Liver Garlic fry',70,'Food'),
('Chicken Lollipop',100,'Food'),
('Chicken Spring Rolls',80,'Food'),
('Chicken Stuffed Papad',100,'Food'),
('Crispy Chicken',130,'Food'),
...
('Chicken Caferal',130,'Food'),
('Chicken Satay',130,'Food'),
('Chicken Vindaloo',130,'Food'),
('Chicken Xacutti',130,'Food'),
...
('Chicken Cutlets',80,'Food'),
('Chicken Grilled',220,'Food'),
('Chicken Boiled',220,'Food'),
('Chicken Fried',220,'Food'),
('Chicken Pepper Steak',130,'Food'),
('Chicken Roast',130,'Food'),
('Chicken Shashlik',130,'Food'),
('Chicken Sizzler',140,'Food'),
('Chicken Steak',130,'Food'),
('Chicken Stroganoff',130,'Food'),
('Baked Vegetables in White Sauce',110,'Food'),
('Chicken Long Fong Soup',80,'Food'),
('Hot N Sour Soup Veg',80,'Food'),
('Hot N Sour Soup Chicken',80,'Food'),
('Manchow Soup Veg',80,'Food'),
('Manchow Soup Chicken',80,'Food'),
('Manchow Soup Sea Food',80,'Food'),
('Spicy Chicken Soup',80,'Food'),
('Spicy Sea Food Soup',100,'Food'),
('Sweet Corn Soup Veg',80,'Food'),
('Sweet Corn Soup Chicken',80,'Food'),
('Chicken 65',170,'Food'),
('Chicken In Hot Black Garlic',130,'Food'),
('Chicken In Ginger Garlic Sauce',130,'Food'),
('Chicken In Schezwan Garlic Sauce',130,'Food'),
('Chicken Chilly',130,'Food'),
('Chicken Manchurian',130,'Food'),
('Chicken Schezwan',130,'Food'),
...
('Roasted Chicken In Chilly Sauce',140,'Food'),
('Sweet N Sour Chicken',130,'Food'),
...
('Vegetable Manchurian',80,'Food'),
('Chicken Fried Rice',100,'Food'),
...
('Chicken Tandoori',240,'Food'),
('Chicken Tikka',170,'Food'),
('Chicken Rehmi',190,'Food'),
('Chicken Pudina',190,'Food'),
('Chicken Kastoori',190,'Food'),
('Fish Tikka',220,'Food'),
...
('Chapatti',10,'Food'),
('Butter Chicken ',140,'Food'),
('Chicken Masala',130,'Food'),
('Chicken Green Masala',130,'Food'),
('Chicken Handi',130,'Food'),
('Chicken Hyderabadi',130,'Food'),
('Chicken Kadai',130,'Food'),
('Chicken Kheema Pasanda',140,'Food'),
('Chicken Kolhapuri',130,'Food'),
('Chicken Korma',110,'Food'),
('Chicken Moghlai',140,'Food'),
('Chicken Sagwalla',130,'Food'),
('Chicken Tikka Masala',160,'Food'),
...
('Vegetable Hyderabadi',80,'Food'),
('Vegetable Korma',80,'Food'),
('Yellow Dal Fry Tadka',80,'Food'),
('Dal Makhani',100,'Food'),
('Chicken Biryani with Raita',140,'Food'),
('Chicken Polao',130,'Food'),
...
('Jeera Rice',70,'Food'),
('Steam Rice',50,'Food'),
('Vegetable Biryani with Raita',80,'Food'),
('Vegetable Pulao',70,'Food'),
('Choice Of Ice Creams',60,'Food'),
('Caramel Custard',70,'Food'),
('Bibinca With Ice Cream',70,'Food'),
('Fresh Fruit Salad With Ice Cream',80,'Food'),
